...
const redInput = document.getElementById("red-color");
const greenInput = document.getElementById("green-color");
const blueInput = document.getElementById("blue-color");
const seeColor = document.getElementById("see-color");
const btnColor = document.getElementById("btn-color");
const btnClearInput = document.getElementById("btn-clear-input");
const fColor = document.getElementById("favorite-color");
let favoriteColors = [];
//initial load//
let favStrfromDisk = localStorage.getItem("Favorite colors") ?? "[]";
const favColorFromDisk = JSON.parse(favStrfromDisk);
...
const cityList = document.querySelector(".all-cities");
...
cityInput.addEventListener("input", () => {
    ...
    const filteredCities = cities.filter((city) => city.name.toLowerCase().startsWith(cityValue));
...
const randNumberBtn = document.getElementById("add-random-number");
const listOfNumbers = document.getElementById("array-of-numbers");
const sortArrayBtn = document.getElementById("sort-array");
const sortedList = document.getElementById("sorted-array");
const sortArraySizeBtn = document.getElementById("sort-array-size");
const sortedListSize = document.getElementById("sorted-arrays-size");
const arrayNumbers = [];
...
import { animalArray } from "./animals.js";
const startAnimals = document.getElementById("beginning-show");
const alignBtn = document.getElementById("align");
const getBtn = document.getElementById("get-playing-animal");
const startBtn = document.getElementById("btn-start");
const playingAnimals = document.getElementById("animal-show-case");
...
const tasksFromDisk = JSON.parse(tasksArrayStr);
